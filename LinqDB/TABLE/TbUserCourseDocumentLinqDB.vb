    ...
    Public Class TbUserCourseDocumentLinqDB
       ...
       'Define Public Method 
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATED_BY, CREATED_DATE, TB_USER_COURSE_ID, USER_ID, DOCUMENT_TITLE, MS_DOCUMENT_ICON_ID, DOCUMENT_VERSION, DOCUMENT_TYPE, ORDER_BY)"
