...
Namespace TABLE
    ...
    Public Class TbTestingAnswerLinqDB
        ...
        End Sub 
        ' TB_TESTING_ANSWER
        Const _tableName As String = "TB_TESTING_ANSWER"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_TESTING_ANSWER table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_TESTING_ANSWER table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_TESTING_ANSWER table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_TESTING_ANSWER by specified ID key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_TESTING_ANSWER by specified ID key is retrieved successfully.
        '/// <param name=cID>The ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbTestingAnswerLinqDB
            Dim p(1) As SQLParameter
            p(0) = DB.SetBigInt("@_ID", cID)
        ...
        '/// Returns an indication whether the record of TB_TESTING_ANSWER by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction, cmdPara() As SQLParameter) As TbTestingAnswerLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        'Get Insert Statement for table TB_TESTING_ANSWER
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (CREATED_BY, CREATED_DATE, TB_TESTING_ID, TB_TESTING_QUESTION_ID, TIME_SPENT, ANSWER_RESULT, ANSWER_CHOICE)"
                Sql += " OUTPUT INSERTED.ID, INSERTED.CREATED_BY, INSERTED.CREATED_DATE, INSERTED.UPDATED_BY, INSERTED.UPDATED_DATE, INSERTED.TB_TESTING_ID, INSERTED.TB_TESTING_QUESTION_ID, INSERTED.TIME_SPENT, INSERTED.ANSWER_RESULT, INSERTED.ANSWER_CHOICE"
                Sql += " VALUES("
                sql += "@_CREATED_BY" & ", "
                sql += "@_CREATED_DATE" & ", "
                sql += "@_TB_TESTING_ID" & ", "
        ...
        'Get update statement form table TB_TESTING_ANSWER
        ...
        'Get Delete Record in table TB_TESTING_ANSWER
        ...
        'Get Select Statement for table TB_TESTING_ANSWER
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATED_BY, CREATED_DATE, UPDATED_BY, UPDATED_DATE, TB_TESTING_ID, TB_TESTING_QUESTION_ID, TIME_SPENT, ANSWER_RESULT, ANSWER_CHOICE FROM " & tableName
                Return Sql
            End Get
        End Property
