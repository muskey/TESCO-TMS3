...
Namespace TABLE
    ...
    Public Class TbTestingAnswerHisLinqDB
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of TB_TESTING_ANSWER_HIS by specified TB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID key is retrieved successfully.
        '/// <param name=cTB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID>The TB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByTB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID(cTB_TESTING_HIS_ID As Long, cTB_TESTING_QUESTION_HIS_ID As Long, trans As SQLTransaction) As Boolean
            Dim cmdPara(3)  As SQLParameter
            cmdPara(0) = DB.SetText("@_TB_TESTING_HIS_ID", cTB_TESTING_HIS_ID) 
            cmdPara(1) = DB.SetText("@_TB_TESTING_QUESTION_HIS_ID", cTB_TESTING_QUESTION_HIS_ID) 
            Return doChkData("TB_TESTING_HIS_ID = @_TB_TESTING_HIS_ID AND TB_TESTING_QUESTION_HIS_ID = @_TB_TESTING_QUESTION_HIS_ID", trans, cmdPara)
        End Function

        '/// Returns an duplicate data record of TB_TESTING_ANSWER_HIS by specified TB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID key is retrieved successfully.
        '/// <param name=cTB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID>The TB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByTB_TESTING_HIS_ID_TB_TESTING_QUESTION_HIS_ID(cTB_TESTING_HIS_ID As Long, cTB_TESTING_QUESTION_HIS_ID As Long, cID As Long, trans As SQLTransaction) As Boolean
            Dim cmdPara(3)  As SQLParameter
            cmdPara(0) = DB.SetText("@_TB_TESTING_HIS_ID", cTB_TESTING_HIS_ID) 
            cmdPara(1) = DB.SetText("@_TB_TESTING_QUESTION_HIS_ID", cTB_TESTING_QUESTION_HIS_ID) 
            cmdPara(2) = DB.SetBigInt("@_ID", cID) 
            Return doChkData("TB_TESTING_HIS_ID = @_TB_TESTING_HIS_ID AND TB_TESTING_QUESTION_HIS_ID = @_TB_TESTING_QUESTION_HIS_ID And ID <> @_ID", trans, cmdPara)
        End Function
