...
#Region "Connect With ini"
        Private Shared ReadOnly Property INIFileName() As IniReader
            Get
                ...
                Dim INIFlie As String = "C:\Windows\TESCO-TMS3.ini"
        ...
        Public Shared ReadOnly Property DBDbUserID() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("DbUserID")
            End Get
        End Property
        ...
        Public Shared ReadOnly Property DBDbPwd() As String
            Get
                Dim ini As IniReader = INIFileName
                Return ini.ReadString("DbPwd")
                'Return DeCripPwd(ini.ReadString("DbPwd"))
            End Get
        End Property
